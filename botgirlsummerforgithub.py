...
def chirp():
    ...
    if datetime.date.today().weekday() == 3:
        msg = 'It\'s THIRSTday, which means I\'m supposed to remind you to stay hydrated! Grab your favorite glass, or mug, or water bottle, or grab a freakin\' goblet if you want to, it\'s your life, just make sure you fill that sucker up all the way and enjoy some water! #thursdaythoughts #botgirlsummer #hotgirlsummer'
